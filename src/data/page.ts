export const data = {
  ...
  organic_coconut_flour: {
    ...
    title: [
      { text: "ORGANIC", color: "#fff", size: "60px", font: "futuraBold" },
      { text: "COCONUT", color: "black", size: "56px", font: "futuraBold" },
      { text: "FLOUR", color: "black", size: "78px", font: "archivo" },
    ],
    titleMb: [
  ...
  organic_coconut_sugar: {
    ...
    title: [
      { text: "Organic", color: "#3B281B", size: "60px", font: "futuraBold" },
      { text: "Coconut", color: "black", size: "56px", font: "futuraBold" },
      { text: "Sugar", color: "black", size: "76px", font: "archivo" },
      {
  ...
  organic_desiccated_coconut: {
    ...
    title: [
      { text: "ORGANIC", color: "#2C4523", size: "60px", font: "futuraBold" },
      {
        text: "DESICCATED  ",
        color: "black",
        size: "49px",
  ...
  coil_extravergin: {
    ...
    title: [
      { text: "Organic", color: "#7F4C28", size: "60px", font: "futuraBold" },
      { text: "Virgin", color: "black", size: "80px", font: "futuraBold" },
      { text: "Coconut Oil", color: "black", size: "38px", font: "archivo" },
    ],
    titleMb: [
  ...
  coconut_chocolate_spread: {
    ...
    title: [
      { text: "COCONUT", color: "#372115", size: "58px", font: "futuraBold" },
      { text: "CHOCOLATE", color: "black", size: "50px", font: "futuraBold" },
      { text: "SPREAD", color: "black", size: "69px", font: "archivo" },
    ],
    titleMb: [
  ...
  organic_coconut_puree: {
    ...
    title: [
      { text: "Organic", color: "#AC4E2B", size: "60px", font: "futuraBold" },
      { text: "Coconut", color: "black", size: "56px", font: "futuraBold" },
      { text: "Puree", color: "black", size: "78px", font: "archivo" },
    ],
    titleMb: [
  ...
  organic_coconut_milk: {
    ...
    title: [
      { text: "ORGANIC", color: "#1A523E", size: "60px", font: "futuraBold" },
      {
        text: "COCONUT  ",
        color: "black",
        size: "56px",
      ...
      { text: "MILK", color: "black", size: "103px", font: "archivo" },
    ],
    titleMb: [
  ...
  infused_virgin_coconut_oil: {
    ...
    title: [
      { text: "Infused", color: "black", size: "45px", font: "futuraBold" },
      { text: "Virgin", color: "black", size: "52px", font: "futuraBold" },
      { text: "Coconut", color: "black", size: "36px", font: "futuraBold" },
      { text: "Oil", color: "black", size: "98px", font: "archivo" },
    ],
    titleMb: [
  ...
  infused_virgin_coconut_oil_pepper: {
    ...
    title: [
      ...
      { text: "Virgin", color: "black", size: "52px", font: "futuraBold" },
      { text: "Coconut", color: "black", size: "36px", font: "futuraBold" },
      { text: "Oil", color: "black", size: "94px", font: "archivo" },
    ],
    titleMb: [
      { text: "Infused", color: "black", size: "48px", font: "futuraBold" },
      { text: "Virgin", color: "black", size: "57px", font: "futuraBold" },
  ...
  coconut_chocolate_syrup: {
    ...
    title: [
      { text: "ORGANIC", color: "#372115", size: "58px", font: "futuraBold" },
      { text: "COCONUT", color: "black", size: "54px", font: "futuraBold" },
      { text: "SYRUP", color: "black", size: "74px", font: "archivo" },
    ],
    titleMb: [
