...
const Page: React.FC<{ searchParams: { [key: string]: string } }> = ({
  ...
  return (
    ...
    >
      ...
      /> */}
      <div className="relative bg-baked-chips-bg-left bg-baked-chips-bg-right text-white flex flex-col lg:flex-row items-start min-h-[100vh] w-full z-10 pb-5 lg:pt-[120px] pt-[40px] bg-[url('/images/background/desiccated-bg-img.jpg')] bg-cover bg-center">
        <LeftContainer
