...
const Page: React.FC<{ searchParams: { [key: string]: string } }> = ({
  ...
  return (
    ...
    >
      ...
      /> */}
      <div className="relative bg-yellow-baked-chips-bg-left bg-baked-chips-bg-right text-white flex flex-col lg:flex-row justify-between min-h-[100vh] w-[100%] items-center z-10 pb-5">
        <LeftContainer
          imgSrc={chip.imgUri}
